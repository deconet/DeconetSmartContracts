...
.then(accounts => {
  ...
  return apiCallsContract.methods.safeWithdrawAmount().call()
})
.then(safeWithdrawAmount => {
  console.log('Got safeWithdrawAmount of '+safeWithdrawAmount)
  return apiCallsContract.methods.withdrawEther(safeWithdrawAmount).send({
    from: ownerAddress,
    gas: 3000000,
